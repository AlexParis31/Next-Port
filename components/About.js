...
const Aboutt = () => {
    return (
    <div id="about"> 
        <div className='p-5 text-white z-[2] bg-center bg-cover customTwo-img '>
            <div class="py-16  ">  
